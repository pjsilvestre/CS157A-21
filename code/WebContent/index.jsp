...
<body>
    <table class="table table-dark">
        ...
        <tbody>
            ...
            <!-- Assumptions: user has a local MySQL database titled 'clothes', with user 'root' and password 'password'. 
            Additionally, 'clothes' should contain a table 'shirts' with schema 
                (id INT(11), brand VARCHAR(256), size CHAR(1)) and any dummy data for the purposes of this demo.  -->
            <%
        try
        {
